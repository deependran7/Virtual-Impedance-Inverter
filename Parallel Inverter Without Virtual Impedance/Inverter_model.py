...
def Inverter_Controller(t,x,RL,XL,m1,m2,n1,n2,Kpc,Kic,Kpv,Kiv):
    ...
    #grid model
    #vbD = rN*(ioD1+ioD2 - iloadD)
    #vbQ = rN*(ioQ1+ioQ2 - iloadQ)
    ...
    #vid1_dot = (1/T_inv)*(-vid1 + vfdref1*Vdc*K_inv)
    #viq1_dot = (1/T_inv)*(-viq1 + vfqref1*Vdc*K_inv)
    ...
    #vid2_dot = (1/T_inv)*(-vid2 + vfdref2*Vdc*K_inv)
    #viq2_dot = (1/T_inv)*(-viq2 + vfqref2*Vdc*K_inv)
    ...
    #Load modelling
    #iloadD_dot = (-w0*RL/XL)*iloadD + w0*iloadQ + (w0/XL)*vbD;
    #iloadQ_dot = (-w0*RL/XL)*iloadQ - w0*iloadD + (w0/XL)*vbQ;
...
# define symbols
#Inverter Symbols
vid1,viq1,ild1,ilq1,vod1,voq1,iod1,ioq1 = symbols(['v_id1','v_iq1','i_ld1','i_lq1','v_od1','v_oq1','i_od1','i_oq1'])
vid2,viq2,ild2,ilq2,vod2,voq2,iod2,ioq2 = symbols(['v_id2','v_iq2','i_ld2','i_lq2','v_od2','v_oq2','i_od2','i_oq2'])
